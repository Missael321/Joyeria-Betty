...
<h3 class=" text-center text-primary my-5 mx-5"><b>Registro de un nuevo vendedor</b></h3>
      <div class="container">
        <div>
          <div class="col-md-10 col-md-offset-2">
              <div class="panel panel-primary">   
                      ...
                      <table width="100%">
                      <form action="alta_vendedor.php" method="post" id="frmvendedor" enctype="multipart/form-data">
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombreVendedor">Nombre Completo:</label></td><td><input type="text" class="form-control my-2" name="nombreVendedor" id="nombreVendedor" placeholder="Nombre completo del vendedor" required autofocus autocomplete="off" pattern="[A-Za-z ]+" title="Escribe el nombre del Vendedor SIN acentos o números"></td>
                      </tr> 
                      <tr class="espacio"> 
                      <td align="right"> <label for="tel">Teléfono:</label></td><td><input type="text" class="form-control my-2" name="telefono" id="telefono" placeholder="Numero telefonico del vendedor" required autocomplete="off" minlength="10" maxlength="10" pattern="[0-9]+" title="Escribe un número telefonico válido e.j: 9191234812"></td>
                      </tr>
                      <tr class="espacio"> 
                      <td align="right"><label for="correo">Correo:</label></td><td><input type="email" class="form-control my-2" name="correo" id="correo" placeholder="Direccion de correo electronico del vendedor" required autocomplete="off" maxlength="30" title="Escribe una dirección de correo válido e.j: correo@mail.com" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}"></td>
                      </tr>
                      <tr class="espacio"> 
                      <td align="right"> <label for="dirección">Dirección:</label></td><td><input type="text" class="form-control my-2" name="direccion" id="dirección" placeholder="Domicilio del vendedor" required autocomplete="off" minlength="1" title="Escribe la dirección del Vendedor"></td>
                      </tr>
                      <tr>
