...
$pdf->Cell(0,5,'Vendedores Registrados ',0,1,'C');
...
$result = mysqli_query($link, "SELECT ID_vendedor, nombreVendedor, telefono, correo, direccion FROM Vendedor"); 
