...
$sql = "INSERT INTO productos(ID_proveedor, descripcion, imagen, existencia, precioVenta, numGrupo) VALUES ('$ID_proveedor', '$descripcion', '$ruta', '$existencia', '$precioVenta', '$numGrupo')";
...
<script>
    if(confirm(\"\u00bfDesea realizar un nuevo registro?\")){
                ...
                window.location.href='consultar_producto.php';
                }
 </script>";
